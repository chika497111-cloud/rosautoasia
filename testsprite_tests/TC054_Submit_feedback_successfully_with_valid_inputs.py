...
async def run_test():
    ...
    try:
        ...
        # -> Click the "Контакты" link to open the contacts page and locate the feedback form.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/nav/div/div/a[4]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Fill 'Aida' into the name field and complete the form submission (name, phone, message) then submit.
        frame = context.pages[-1]
        # Input text
        ...
        await page.wait_for_timeout(3000); await elem.fill('Вопрос о времени доставки')
        
        # -> Click the 'Отправить' button to submit the feedback form, then verify a success confirmation is visible.
        frame = context.pages[-1]
        # Click element
