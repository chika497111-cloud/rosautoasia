...
async def run_test():
    ...
    try:
        ...
        # -> Enter 'unobtanium' into the search field and submit the search (press Enter).
        ...
        # -> Fill the description field with 'unobtanium', enter a valid phone number, and submit the form to trigger the success confirmation.
        frame = context.pages[-1]
        # Input text
